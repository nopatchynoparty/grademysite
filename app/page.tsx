            ...
            <div className="rounded-2xl border border-border bg-white shadow-xl overflow-hidden dm-card">
              ...
              <div className="p-6">
                ...
                <div className="border border-border rounded-xl overflow-hidden mb-3">
                  ...
                  <div className="p-3">
                    <p className="text-xs font-semibold uppercase tracking-wider text-green mb-2">What&apos;s working ✓</p>
                    {[
                      ...
                      <div key={i} className={`mb-3 ${i > 0 ? "pt-3 border-t border-border" : ""}`}>
                    ...
                    <p className="text-xs font-semibold uppercase tracking-wider text-red mt-4 mb-2">What needs fixing ✗</p>
                    {[
